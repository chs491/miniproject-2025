...
1. Visual Studio 프로젝트 생성, WPF MVVM 프로젝트 생성
2. NuGet 패키지 설치
...
4. WPF 애니메이션 기능으로 컨베이어 벨트 구현    
    ...
    https://github.com/user-attachments/assets/6be7df05-1fb8-41b8-b8d7-19f97eb807a7
...
2. MainViewModel.cs 현재 Publish에 맞게 수정
    - BrokerIP, Topic...
3. EntityFramework 사용, Database 테이블 모형(DBFirst)
